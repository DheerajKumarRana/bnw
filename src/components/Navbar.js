...
const Navbar = () => {
    ...
    return (
        <>
            <header className="absolute top-0 left-0 w-full z-40 bg-gradient-to-b from-black/80 to-transparent ">
                <div className="container mx-auto px-8 lg:px-24">
                    <div className="flex justify-between items-start relative">
                        ...
                        <div className="absolute left-1/2 transform -translate-x-1/2 top-0">
                            <Link href="/">
                                <div className="transition-all duration-300 flex flex-col items-center mt-4 w-[120px] h-[90px]" >
                                    <Image
                                        src="/logo-white.png"
