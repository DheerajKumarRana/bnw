    ...
    const projects = [
        {
            ...
            detailsLink: "/projects/tonino-lamborghini-residences-marjan-island",
            id: "tonino"
        },
        {
            ...
            detailsLink: "/projects/radisson-blu-residences-hotel-rak-central",
            id: "radisson"
        }
    ];
                    ...
                    <div className="container mx-auto px-6 md:px-0 md:max-w-5xl text-center">
                        ...
                        <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-12">
                            ...
                            <Link
                                ...
                                className="order-2 md:order-1 thm-btn thm-btn-black !w-full md:!w-[280px] !h-[60px]"
                            >
                                PROJECT DETAILS
                            </Link>
