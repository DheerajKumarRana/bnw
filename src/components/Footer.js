        ...
        <footer className="bg-[#151515] text-white pt-20 pb-10 relative border-t border-gray-800">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-between">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-y-4 gap-x-4 text-sm text-gray-400">
                                    <Link href="/about-us/team" className="hover:text-[#daaf7d] transition-colors">
                                        Team
                                    </Link>
                                    <Link href="/news" className="hover:text-[#daaf7d] transition-colors">
                                        Media
                                    </Link>
                                    <Link href="/contact-us" className="hover:text-[#daaf7d] transition-colors">
                                        Contact Us
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div className="mt-20 flex flex-col xl:flex-row items-start xl:items-start gap-8 w-full">
                            <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
                                <a href="tel:+918766290930" className="w-full md:w-auto">
                                    <button className="thm-btn thm-btn-gold-outline group !w-full md:!min-w-[240px] !h-[75px] flex items-center justify-center px-6">
                                        ...
                                        <div className="text-center leading-tight">
                                            <span className="block text-[14px] font-bold tracking-widest text-[#daaf7d] group-hover:text-white transition-colors">
                                                +91 8766290930
                                            </span>
                                        </div>
                                    </button>
                                ...
                                <button
                                    ...
                                    className="thm-btn thm-btn-gold !w-full md:!min-w-[240px] !h-[75px] flex items-center justify-center bg-gradient-to-b from-[#e8c69f] to-[#daaf7d] border-none"
                                >
                    ...
                    <div className="lg:col-span-5 flex flex-col items-start lg:pl-10">
                        ...
                        <div className="mt-10 flex flex-col gap-6 w-full">
                            <div>
                                <p className="text-sm text-white font-bold mb-1">Office – <span className="font-normal text-gray-400">Ground Floor, A7, Ring Rd, Vikram Vihar, Part 4, Lajpat Nagar, New Delhi, Delhi 110024</span></p>
                            </div>
                            <div>
                                <p className="text-sm text-white font-bold mb-1">Phone – <span className="font-normal text-gray-400">+91 98994 58541, +91 8766290930</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="fixed bottom-10 right-10 z-50">
                    <a href="https://wa.me/+919899458541" target="_blank" rel="noopener noreferrer">
